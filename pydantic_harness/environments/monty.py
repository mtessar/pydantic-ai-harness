...
Requires the `pydantic-monty` package: `pip install pydantic-harness[monty]`
"""
...
if TYPE_CHECKING:
    ...
    from pydantic_harness.toolsets.code_execution._abstract import FunctionCallback
...
try:
    ...
    raise ImportError(
        ...
        'you can use the `monty` optional group — `pip install "pydantic-harness[monty]"`'
    ) from _import_error
