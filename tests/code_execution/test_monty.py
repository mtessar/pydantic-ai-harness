...
# TODO: Remove xfail when PR #4755 lands — schema_to_signature returns `-> Any` instead of `-> int`
@pytest.mark.xfail(reason='PR #4755: schema_to_signature produces less precise return types than function_to_signature')
...
# TODO: Remove xfail when PR #4755 lands — schema_to_signature produces different description format
@pytest.mark.xfail(reason='PR #4755: schema_to_signature produces different signatures than function_to_signature')
...
async def test_run_python_syntax_error():
    ...
    from pydantic_harness.toolsets.code_execution._abstract import CodeSyntaxError
...
async def test_type_check_catches_type_error():
    ...
    from pydantic_harness.toolsets.code_execution._abstract import CodeTypingError
...
async def test_prints_included_in_timeout_error():
    ...
    from pydantic_harness.toolsets.code_execution._abstract import CodeExecutionTimeout
