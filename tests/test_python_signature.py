...
from pydantic_harness._python_signature import (
    FunctionParam,
    FunctionSignature,
    GenericTypeExpr,
    TypeFieldSignature,
...
# NOTE: Tests for FunctionToolDefinition.python_signature removed —
# FunctionToolDefinition is from PR #4755, not yet in pydantic-ai-slim.
# TODO: Re-add when PR #4755 lands.
...
# NOTE: test_function_tool_definition_eq_non_tool removed — depends on FunctionToolDefinition (PR #4755)


def test_get_type_name_repr_fallback():
    """Types without __name__ use repr fallback, NoneType returns 'None'."""
    from pydantic_harness._python_signature import _get_type_name  # pyright: ignore[reportPrivateUsage]
...
def test_schema_allows_null_anyof():
    ...
    from pydantic_harness._python_signature import _schema_allows_null  # pyright: ignore[reportPrivateUsage]
...
def test_collect_referenced_types_skips_already_registered():
    ...
    from pydantic_harness._python_signature import _collect_referenced_types  # pyright: ignore[reportPrivateUsage]
