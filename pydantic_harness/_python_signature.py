# TODO: When PR #4755 lands in pydantic-ai-slim, remove this file and
# switch imports to `from pydantic_ai._python_signature import ...`
...
from pydantic_ai._run_context import RunContext  # private API
from pydantic_ai._utils import is_model_like  # private API
